...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgParu2;

  @NonNull
  public final ProgressBar progressBar;

  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgParu2,
      @NonNull ProgressBar progressBar) {
    this.rootView = rootView;
    this.imgParu2 = imgParu2;
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.img_paru2;
      ImageView imgParu2 = rootView.findViewById(id);
      if (imgParu2 == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((RelativeLayout) rootView, imgParu2, progressBar);
    }
