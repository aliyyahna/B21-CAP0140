package com.wildan.lungsdetector_md.ml;
...
public final class Model2 {
  ...
  private Model2(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model_2.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Model2 newInstance(@NonNull Context context) throws IOException {
    return new Model2(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Model2 newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Model2(context, options);
  }
